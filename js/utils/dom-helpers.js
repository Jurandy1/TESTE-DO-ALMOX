...
function findDOMElements() {
    ...
    const mappings = [
        ...
        // Modal Leitor Requisição
        ['#modal-leitor-requisicao', 'modalLeitorRequisicao'],
        ['#leitor-drop-zone', 'leitorDropZone'],
        ['#leitor-file-input', 'leitorFileInput'],
        ['#leitor-preview-section', 'leitorPreviewSection'],
        ['#leitor-preview-table', 'leitorPreviewTable'],
        ['#leitor-preview-unidade', 'leitorPreviewUnidade'],
        ['#leitor-preview-count', 'leitorPreviewCount'],
        ['#btn-confirmar-importacao', 'btnConfirmarImportacao'],
        ['#btn-leitor-voltar', 'btnLeitorVoltar'],
        ['#btn-importar-requisicao', 'btnImportarRequisicao'],
        // Histórico Geral
        ['#subview-historico-geral', 'subviewHistoricoGeral'],
        ['#filtro-hist-geral-periodo', 'filtroHistGeralPeriodo'],
        ['#filtro-hist-geral-unidade', 'filtroHistGeralUnidade'],
        ['#filtro-hist-geral-categoria', 'filtroHistGeralCategoria'],
        ['#btn-gerar-relatorio-geral', 'btnGerarRelatorioGeral'],
        ['#chart-itens-mais-req', 'chartItensMaisReq'],
        ['#chart-req-por-unidade', 'chartReqPorUnidade'],
        ['#table-historico-geral', 'tableHistoricoGeral'],
        ...
        ['#input-separacao-itens', 'inputSeparacaoItens'],
        ['#input-separador-nome', 'inputSeparadorNome'],
        ['#input-separador-assinatura', 'inputSeparadorAssinatura'],
